...
public class PlatinumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("calubs_materials:platinum_ore", FEATURE,
				new OreConfiguration(PlatinumOreFeatureRuleTest.INSTANCE, CalubsMaterialsModBlocks.PLATINUM_ORE.get().defaultBlockState(), 6));
		PLACED_FEATURE = PlacementUtils.register("calubs_materials:platinum_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(5), InSquarePlacement.spread(),
						HeightRangePlacement.uniform(VerticalAnchor.absolute(-10), VerticalAnchor.absolute(35)), BiomeFilter.biome()));
		return FEATURE;
	}
	...
	private static class PlatinumOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("calubs_materials:platinum_ore_match"), CUSTOM_MATCH);
		}
